...
var apiKey = 'd26d89578193998f4d00ff8205063534';
let requestToken = 'https://api.themoviedb.org/3/movie/550?api_key=d26d89578193998f4d00ff8205063534';
let username;
let password;
let sessionId;
let listId = '7101979';
...
searchButton === null || searchButton === void 0 ? void 0 : searchButton.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let inputQuery = document.getElementById('search');
